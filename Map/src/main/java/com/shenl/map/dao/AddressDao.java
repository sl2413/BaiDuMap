...
public class AddressDao {
    ...
    private static String sql = "select district_name,parent_id,region_code from sys_district where parent_id=? order by region_code";
     ...
     * 创建时间:   2019/10/24
     */
    public static void  getAddress(Context context, String code,CallBack callBack) {
